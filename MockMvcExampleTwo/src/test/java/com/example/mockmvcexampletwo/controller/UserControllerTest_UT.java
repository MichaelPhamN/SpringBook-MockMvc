...
public class UserControllerTest_UT {
    @Mock
    ...
    public void findUsers_NoContent_HappyPath() throws Exception {
        ...
        assertEquals(expectedStatus, users.getStatusCode());
        assertEquals(Collections.EMPTY_LIST, users.getBody());
    }
    ...
    public void findUsersByEmail_HappyPath() throws Exception {
        ...
        ResponseEntity<List<User>> users = userController.findUsersByName(email);
        HttpStatus expectedStatus = HttpStatus.OK;
        int expectedCollectionSize = 10;
        assertEquals(expectedStatus, users.getStatusCode());
        assertEquals(expectedCollectionSize, users.getBody().size());
    ...
    @Test
    public void findUsersByEmail_NoContent_HappyPath() throws Exception {
        String email = "test@gmail.com";
        when(userService.findUsersByEmail(email))
                .thenReturn(Collections.EMPTY_LIST);
        ResponseEntity<List<User>> users = userController.findUsersByName(email);
        HttpStatus expectedStatus = HttpStatus.NO_CONTENT;
        assertEquals(expectedStatus, users.getStatusCode());
